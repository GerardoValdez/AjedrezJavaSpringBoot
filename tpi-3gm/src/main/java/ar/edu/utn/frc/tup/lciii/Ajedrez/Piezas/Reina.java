...
public class Reina extends Pieza {
    ...
    @Builder
    public Reina(Posicion posicion, Color colorPieza, EstadoPieza estado, String icono, NombrePiezas nombre, Integer valor) {
    ...
    public List<Posicion> posiblesMovimientos(Posicion posicionActual) {
        ...
        for (int[] coordenada : movimientosReina) {
