...
public class Alfil extends Pieza {
    ...
    private int[][] movimientosAlfil = {
            {-1, -1}, {-1, 1},
            {1, -1}, {1, 1}
    };

    @Builder
    public Alfil(Posicion posicion, Color colorPieza, EstadoPieza estado, String icono, NombrePiezas nombre, Integer valor) {
    ...
    public List<Posicion> posiblesMovimientos(Posicion posicionActual) {
        ...
        for (int[] coordenada : movimientosAlfil) {
