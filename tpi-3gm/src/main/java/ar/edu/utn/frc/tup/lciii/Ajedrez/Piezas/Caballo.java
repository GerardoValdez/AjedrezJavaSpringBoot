...
public class Caballo extends Pieza {
    ...
    private int[][] movimientosCaballo = {
            {-2, -1}, {-1, -2}, {1, -2}, {2, -1},
            {2, 1}, {1, 2}, {-1, 2}, {-2, 1}
    };

    @Builder
    public Caballo(Posicion posicion, Color colorPieza, EstadoPieza estado, String icono, NombrePiezas nombre, Integer valor) {
    ...
    public List<Posicion> posiblesMovimientos(Posicion posicionActual) {
        ...
        for (int[] coordenada : movimientosCaballo) {
